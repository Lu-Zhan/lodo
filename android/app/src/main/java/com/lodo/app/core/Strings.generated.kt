...
object Strings {
    private val table: Map<String, Map<Lang, String>> = mapOf(
        ...
        "shared.todo" to mapOf(Lang.ZH to "任务", Lang.EN to "Task"),
        ...
        "shared.no_tasks_yet" to mapOf(Lang.ZH to "暂无任务", Lang.EN to "No tasks yet"),
        ...
        "shared.upcoming" to mapOf(Lang.ZH to "未来任务", Lang.EN to "Upcoming"),
        ...
        "android_notif.daily_todo_digest" to mapOf(Lang.ZH to "每日任务汇总", Lang.EN to "Daily Task Digest"),
        ...
        "android_notif.no_tasks_today" to mapOf(Lang.ZH to "今日暂无任务 🎉", Lang.EN to "No tasks today 🎉"),
